WITH "result_action" AS (
    ...
    WHERE
        "action_account"."action_id" = "action"."id" AND
        "action_account"."account_id" = "account"."id" AND
        "action_account"."deleted_at" IS NULL
    RETURNING
        "action_account"."id",
